package com.imooc.ad.interceptor;
...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info(STRING_START + "{} 开始调用--> {} 参数:{} 参数名称:{}", url, target, params, JSON.toJSONString(signature.getParameterNames()));
        ...
        log.info("\n{} 调用结束<-- {} 返回值:{} 耗时:{}ms" + STRING_END, url, target, JSONObject.toJSONStringWithDateFormat(result, dateFormat, SerializerFeature.WriteMapNullValue), timeConsuming);
        return result;
