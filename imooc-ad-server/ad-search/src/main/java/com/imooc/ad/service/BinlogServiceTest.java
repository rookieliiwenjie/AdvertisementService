...
//        client.setBinlogPosition();
        ...
        client.registerEventListener(event -> {
            ...
            EventType eventHeader = event.getHeader().getEventType();
            if (eventHeader == EventType.TABLE_MAP) {
                TableMapEventData data33 = event.getData();
                String tableName = data33.getTable();
                String dbName = data33.getDatabase();
